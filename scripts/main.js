...
document.getElementById('role-title').textContent = departmentChoice + " is een leuke afdeling om te werken. Er werken op dit moment " + departments[departmentChoice].numberOfEmployees + " medewerkers.";
...
switch (jobChoice) {
    ...
    case "2":
        ...
        break;
    case "3":
        console.log("Je koos " + departments[departmentChoice].jobs[3].title  +". Een uitdagende rol! " + departments.marketing.jobs[0].description);
        break;
    default:
        console.log("Ongeldige keuze. Probeer het opnieuw door de pagina te verversen.")
}
